...
*/
	...
	h_Library = LoadLibrary( "spirit/cl_dlls/server.dll" );
	pbConfig.initConfiguration( "spirit/bot/parabot.cfg" );
	pbConfig.initPersonalities( "spirit/bot/characters.cfg" );

	// always load chatfile, might be enabled ingame:
	char chatFile[256];
	strcpy( chatFile, "spirit/bot/" );
